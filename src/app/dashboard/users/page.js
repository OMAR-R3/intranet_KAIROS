                ...
                <>
                            ...
                            <tbody>
                                {usuarios.map(u => (
                                    <tr key={u.id} style={styles.tr}>
                                        ...
                                        <td style={styles.td}>
                                            <span style={{ ...styles.badge, ...rolColor[u.rol] }}>
                                                {u.rol}
                                            </span>
                                        </td>
                                        <td style={styles.td}>
                    ...
                    {totalPages > 1 && (
                        <div style={styles.pagination}>
                            <button style={styles.pageBtn} onClick={() => setPage(p => p - 1)} disabled={page === 1}>← Anterior</button>
                            <span style={styles.pageInfo}>Página {page} de {totalPages}</span>
                            <button style={styles.pageBtn} onClick={() => setPage(p => p + 1)} disabled={page === totalPages}>Siguiente →</button>
                        </div>
                    )}
                </>
            )}
